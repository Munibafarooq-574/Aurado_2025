...
class HabitScreen extends StatefulWidget {
  ...
  const HabitScreen({Key? key, this.task}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: taskManager.getTasksByCategory('Habit').isEmpty
                    ? Center(
                  child: Column(
                    ...
                    : ListView.builder(
                  itemCount: taskManager.getTasksByCategory('Habit').length,
                  itemBuilder: (context, index) {
                    final task = taskManager.getTasksByCategory('Habit')[index];
